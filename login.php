...
if(isset($_POST['sub2'])){
	$uemail=$_POST['uemail'];
	$upass=$_POST['upass'];
	$q3="select * from userlogin where email='$uemail' and password='$upass'";
...
<p class="text-center mt-3" style="font-size:20px"> <i class="fas fa-user-secret  text-danger"></i> Login Area </p>
<div class="row justify-content-center">

<div class="col-md-4 col-sm-6 mt-3">
<form class=" px-3 py-3 shadow" action="" method="post">
<div class="form-group">
<label><strong><i class="fa fa-user"></i> Email</strong></label><input type="email" name="uemail" placeholder="Email" class="form-control" required>
</div>
<div class="form-group">
<label><strong><i class="fa fa-key"></i> Password</strong></label><input type="password" name="upass" placeholder="Password" class="form-control" required>
</div>
<div class="form-group">
